"""Plot learning curves for N-step DQN on MiniGrid FourRooms (stacked observations)."""
...
def plot_learning_curve(run_dir, window=200):
    """Plot learning curve for N-step DQN."""
    ...
    ax.set_title("MiniGrid FourRooms: N-step DQN", fontsize=14, fontweight="bold")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot learning curve for N-step DQN on MiniGrid FourRooms"
    )
    parser.add_argument(
