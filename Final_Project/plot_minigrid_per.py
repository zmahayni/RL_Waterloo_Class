"""Plot learning curves for PER DQN on MiniGrid FourRooms (stacked observations)."""
...
def plot_learning_curve(run_dir, window=200):
    """Plot learning curve for PER DQN."""
    ...
    ax.set_title("MiniGrid FourRooms: PER DQN", fontsize=14, fontweight="bold")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot learning curve for PER DQN on MiniGrid FourRooms"
    )
    parser.add_argument(
