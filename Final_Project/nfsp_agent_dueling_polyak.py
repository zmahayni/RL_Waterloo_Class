"""NFSP agent with Dueling DQN + Polyak target updates as RL component."""
...
class NFSPAgentDuelingPolyak:
    ...
    def __init__(
        ...
        """
        Initialize NFSP agent with Dueling + Polyak.
        ...
        # RL: Dueling Q-networks with Polyak updates
    ...
    def train_rl(self, batch_size=32):
        """Train RL policy (Dueling DQN with Polyak updates)."""
        ...
        # Polyak target update (after each gradient step)
        self._polyak_update()
