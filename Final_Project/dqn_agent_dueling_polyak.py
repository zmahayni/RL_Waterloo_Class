"""DQN agent with Dueling architecture and Polyak target updates."""
...
class DQNAgentDuelingPolyak:
    """Deep Q-Network agent with Dueling architecture and Polyak target updates."""
    ...
    def __init__(
        ...
        """
        Initialize DQN agent with Dueling architecture and Polyak updates.
    ...
    def train(self, batch_size=32):
        ...
        # Polyak update after each gradient step
        self._polyak_update()
