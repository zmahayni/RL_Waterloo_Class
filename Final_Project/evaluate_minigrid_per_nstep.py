"""Standalone evaluation script for PER+N-step DQN on MiniGrid FourRooms with stacked observations."""
...
def evaluate_agent(checkpoint_path, num_episodes=200, seed=None):
    """
    Evaluate PER+N-step DQN agent on MiniGrid FourRooms.
    ...
    # Print results
    print("\n" + "=" * 60)
    print("Evaluation Results (PER+N-step DQN):")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate PER+N-step DQN on MiniGrid FourRooms with stacked observations"
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
