"""Standalone evaluation script for Leduc Hold'em Dueling DQN + Polyak agent."""
...
def evaluate_agent(
    ...
    """
    Evaluate Dueling DQN + Polyak agent from checkpoint against rule-based opponent.
    ...
    # Initialize and load Dueling DQN + Polyak agent
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate Dueling DQN + Polyak agent on Leduc Hold'em"
    )
    parser.add_argument(
