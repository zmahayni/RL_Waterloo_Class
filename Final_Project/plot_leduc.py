"""Plot learning curves for Leduc Hold'em experiments."""
...
def plot_learning_curve(run_dir, window=200):
    ...
    ax.set_title("Leduc Hold'em: DQN Learning Curve", fontsize=14, fontweight="bold")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot learning curves for Leduc Hold'em"
    )
    parser.add_argument(
