"""Standalone evaluation script for NFSP baseline agent (using average policy)."""
...
def evaluate_agent(checkpoint_path, num_episodes=1000, seed=42, agent_name="player_0"):
    ...
    # Initialize and load NFSP agent
    agent = NFSPAgentBaseline(
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate NFSP baseline agent on Leduc Hold'em"
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
