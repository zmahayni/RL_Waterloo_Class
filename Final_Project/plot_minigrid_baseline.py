"""Plot learning curves for baseline DQN on MiniGrid FourRooms (stacked observations)."""
...
def plot_learning_curve(run_dir, window=200):
    """Plot learning curve for baseline DQN."""
    ...
    ax.set_title("MiniGrid FourRooms: Baseline DQN", fontsize=14, fontweight="bold")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot learning curve for baseline DQN on MiniGrid FourRooms"
    )
    parser.add_argument(
