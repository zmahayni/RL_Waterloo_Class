"""Standalone evaluation script for Leduc Hold'em Dueling DQN agent."""
...
def evaluate_agent(
    ...
    """
    Evaluate Dueling DQN agent from checkpoint against rule-based opponent.
    ...
    # Initialize and load Dueling DQN agent
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate Dueling DQN agent on Leduc Hold'em"
    )
    parser.add_argument(
