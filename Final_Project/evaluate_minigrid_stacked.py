"""Standalone evaluation script for DQN on MiniGrid FourRooms with stacked observations."""
...
def evaluate_agent(checkpoint_path, num_episodes=200, seed=None):
    """
    Evaluate DQN agent on MiniGrid FourRooms.
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate DQN on MiniGrid FourRooms with stacked observations"
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
